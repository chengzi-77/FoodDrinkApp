...
| 评分项 | 权重 | 实现说明 |
|--------|------|----------|
| UI/UX 与无障碍 | 30% | 统一绿色主题、深色模式、字体缩放、遵循 WCAG 指南 |
| 移动硬件 | 20% | 摄像头、GPS、语音、振动+触觉反馈 |
| 功能性 | 20% | 增删改查、滑动删除、搜索 |
| 验证与错误处理 | 10% | 输入验证、用户友好的错误提示 |
| 代码质量 | 10% | MVVM 模式、DRY 原则、规范命名 |
| 部署 | 5% | 支持安卓手机和平板 |
| GitHub 使用 | 5% | 定期提交、有意义的提交信息 |
